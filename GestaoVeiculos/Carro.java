...
public class Carro extends VeiculoBase{
    private static final double TAXA_DEPRECIACAO = 0.1; // Taxa de depreciação de 10% ao ano

    public Carro(String marca, String placa, int ano, double preco){
    ...
    public double calcularTaxaDeUso(){
        double taxa = super.getPreco() * 0.1;
        return taxa;
    }
